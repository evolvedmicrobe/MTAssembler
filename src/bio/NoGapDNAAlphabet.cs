...
namespace Bio
{
    ...
    /// This alphabet allows only for the four base nucleotide symbols.
    /// <para>
    ...
    public class NoGapDnaAlphabet : IAlphabet
    {
        ...
        /// </summary>
        static NoGapDnaAlphabet()
        {
            Instance = new NoGapDnaAlphabet();
        }
        /// <summary>
        /// A large array the size of byte, whose elements are true when the 
        /// byte value is valid, saves hashing time...
        /// </summary>
        private static bool[] ValidByteMappingArray = new bool[Byte.MaxValue + 1];
        /// <summary>
        ...
        /// </summary>
        public static readonly NoGapDnaAlphabet Instance;
        ...
        public unsafe bool ValidateSequence(byte[] symbols, long offset, long length)
        {
            if (symbols == null)
            {
                throw new ArgumentNullException("symbols");
            }
            fixed (bool* src = ValidByteMappingArray)
            {
