...
namespace Bio.IO.SAM
{
    ...
    public class SAMAlignedSequenceHeader
    {
        ...
        private SAMOptionalFieldCollection readOnlyOptionalFieldCollection;
        private Dictionary<string,SAMOptionalField> editableOptionalFieldCollection;
        #endregion
        ...
        /// <summary>
        /// Items are stored either in a light weight read only collection directly 
        /// filtered from the BAM or using a collection of SAMOptionalFields
        /// </summary>
        public bool UsingReadOnlyOptionFieldCollection
        {
            get
            {
                return readOnlyOptionalFieldCollection != null;
            }
        }
        ...
        public void SetPreValidatedCIGAR(string value,int alignmentLength)
        {
            cigar = value;
        ...
        /// Optional fields.
        /// </summary>
        public IEnumerable<SAMOptionalField> OptionalFields 
        { 
            get
            {
                ...
                if (editableOptionalFieldCollection != null)
                {
                    foreach (var kv in editableOptionalFieldCollection)
                    {
        ...
        {
            if(UsingReadOnlyOptionFieldCollection){changeFromReadOnlyToEditableCollection();}
            else if(editableOptionalFieldCollection==null){editableOptionalFieldCollection=new Dictionary<string,SAMOptionalField>();}
            editableOptionalFieldCollection[sof.Tag] = sof;
        }

        public object GetOptionalField(string tag)
        {
            if (UsingReadOnlyOptionFieldCollection)
            {
                return readOnlyOptionalFieldCollection[tag];
            }
            else if (editableOptionalFieldCollection != null)
            {
                return editableOptionalFieldCollection[tag];
            }
            else
            {
                throw new Exception("No option fields are available");
            }
