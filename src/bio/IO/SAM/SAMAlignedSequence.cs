...
namespace Bio.IO.SAM
{
	...
	public class SAMAlignedSequence : IAlignedSequence
	{
		...
		{
			seqHeader.SetPreValidatedCIGAR (value, alignmentLength);
		}
		...
		/// Optional fields.
		/// </summary>
		public List<SAMOptionalField> OptionalFields {
			get {
				return seqHeader.OptionalFields.ToList ();
			}
		}
		...
		public Dictionary<string, object> Metadata {
			get { throw new Exception ("Building meta-data killed performance in mono, so is not done anymore"); }
		}
