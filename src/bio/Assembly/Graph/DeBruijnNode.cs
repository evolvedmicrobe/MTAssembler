...
namespace Bio.Algorithms.Assembly.Graph
{
    ...
    public class DeBruijnNode
    {
        ...
        /// <summary>
        /// I use this for the graph output, can be excluded to save memory later.
        ...
        /// that are either troublesome palindromes or repeated patterns, e.g. TTTTTTT or ACACACACAC
        /// </summary>
        public bool ContainsSelfReference
        {
            get
            {
                //If so, node will refer to itself.
                return this.GetExtensionNodes().Any(x => x == this);
            }
        }

        private byte _visitedNodeExtensions;

        #region NeighborVisited Private Properties

        private bool RightVisited0
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskRightExtension0) == NodeMaskRightExtension0);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskRightExtension0);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskRightExtension0));
        ...
        private bool RightVisited1
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskRightExtension1) == NodeMaskRightExtension1);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskRightExtension1);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskRightExtension1));
        ...
        private bool RightVisited2
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskRightExtension2) == NodeMaskRightExtension2);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskRightExtension2);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskRightExtension2));
        ...
        private bool RightVisited3
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskRightExtension3) == NodeMaskRightExtension3);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskRightExtension3);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskRightExtension3));
        ...
        private bool LeftVisited0
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskLeftExtension0) == NodeMaskLeftExtension0);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskLeftExtension0);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskLeftExtension0));
        ...
        private bool LeftVisited1
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskLeftExtension1) == NodeMaskLeftExtension1);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskLeftExtension1);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskLeftExtension1));
        ...
        private bool LeftVisited2
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskLeftExtension2) == NodeMaskLeftExtension2);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskLeftExtension2);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskLeftExtension2));
        ...
        private bool LeftVisited3
        {
            get
            {
                return ((this._visitedNodeExtensions & NodeMaskLeftExtension3) == NodeMaskLeftExtension3);
            }
            ...
            set
            {
                if (value)
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions | NodeMaskLeftExtension3);
                }
                else
                {
                    this._visitedNodeExtensions = (byte)(this._visitedNodeExtensions & (~NodeMaskLeftExtension3));
        ...
        public bool MarkLeftExtensionAsVisited(DeBruijnNode node)
        {
            if (node == null)
            {
        ...
        public bool MarkRightExtensionAsVisited(DeBruijnNode node)
        {
            if (node == null)
            {
                throw new ArgumentNullException("node");
        ...
        /// <summary>
        /// Retrives the list of right extension nodes along with the orientation if not flagged. Marks the edge in the neighbor and itself as 
        /// visited
        /// </summary>
        /// <returns>List with the left extension node and the orientation.</returns>
        public List<KeyValuePair<DeBruijnNode, bool>> GetRightExtensionNodesWithOrientationMarkingEdgeAsVisited(bool returnVisited=true)
        {
            lock (this)
            {
                List<KeyValuePair<DeBruijnNode, bool>> extensions = new List<KeyValuePair<DeBruijnNode, bool>>();

                if (this.ValidExtensionsRequried)
                {
                    if (this.RightExtension0 != null && !this.InvalidRightExtension0 && (returnVisited || !this.RightVisited0))
                    {
                       
                            extensions.Add(new KeyValuePair<DeBruijnNode,bool>(this.RightExtension0, this.OrientationRightExtension0));
                        
                    }

                    if (this.RightExtension1 != null && !this.InvalidRightExtension1 && (returnVisited || !this.RightVisited1))
                    {
                        
                            extensions.Add(new KeyValuePair<DeBruijnNode,bool>(this.RightExtension1, this.OrientationRightExtension1));
                        
                    }

                    if (this.RightExtension2 != null && !this.InvalidRightExtension2 && (returnVisited || !this.RightVisited2))
                    {
                       
                            extensions.Add(new KeyValuePair<DeBruijnNode,bool>(this.RightExtension2, this.OrientationRightExtension2));
                        
                    }

                    if (this.RightExtension3 != null && !this.InvalidRightExtension3 && (returnVisited || !this.RightVisited3))
                    {
                        
                            extensions.Add(new KeyValuePair<DeBruijnNode,bool>(this.RightExtension3, this.OrientationRightExtension3));
                        
                    }
                }
                else
                {
                    if (this.RightExtension0 != null && (returnVisited || !this.RightVisited0))
                    {
                    ...
                    if (this.RightExtension1 != null && (returnVisited || !this.RightVisited1))
                    {
                    ...
                    if (this.RightExtension2 != null && (returnVisited || !this.RightVisited2))
                    {
                    ...
                    if (this.RightExtension3 != null && (returnVisited || !this.RightVisited3))
                    {
                 ...
                 //things on right with same orientation connected on left, otherwise right
                foreach (var kv in extensions)
                {
                    this.MarkRightExtensionAsVisited(kv.Key);
                    if (!kv.Value)
                    {
                        kv.Key.MarkRightExtensionAsVisited(this);
                    }
                    else
                    {
                        kv.Key.MarkLeftExtensionAsVisited(this);
                    }
                }
                return extensions;
            }
        ...
        /// <summary>
        /// Retrives the list of left extension nodes along with the orientation. Marks the edge in the neighbor and itself as 
        /// visited.  Can optionally only return the unvisited nodes
        /// </summary>
        /// <returns>List with the left extension node and the orientation.</returns>
        public List<KeyValuePair<DeBruijnNode, bool>> GetLeftExtensionNodesWithOrientationMarkingEdgeAsVisited(bool returnVisited = true)
        {
            lock (this)
            {
                List<KeyValuePair<DeBruijnNode, bool>> extentions = new List<KeyValuePair<DeBruijnNode, bool>>();

                if (this.ValidExtensionsRequried)
                {
                    if (this.LeftExtension0 != null && !this.InvalidLeftExtension0 && (returnVisited || !this.LeftVisited0))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension0, this.OrientationLeftExtension0));
                       
                    }

                    if (this.LeftExtension1 != null && !this.InvalidLeftExtension1 && (returnVisited || !this.LeftVisited1))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension1, this.OrientationLeftExtension1));
                        
                    }

                    if (this.LeftExtension2 != null && !this.InvalidLeftExtension2 && (returnVisited || !this.LeftVisited2))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension2, this.OrientationLeftExtension2));
                        
                    }

                    if (this.LeftExtension3 != null && !this.InvalidLeftExtension3 && (returnVisited || !this.LeftVisited3))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension3, this.OrientationLeftExtension3));
                        
                    }
                }
                else
                {
                    if (this.LeftExtension0 != null && (returnVisited || !this.LeftVisited0))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension0, this.OrientationLeftExtension0));
                        
                    }

                    if (this.LeftExtension1 != null && (returnVisited || !this.LeftVisited1))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension1, this.OrientationLeftExtension1));
                        
                    }

                    if (this.LeftExtension2 != null && (returnVisited || !this.LeftVisited2))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension2, this.OrientationLeftExtension2));
                        
                    }
                    if (this.LeftExtension3 != null && (returnVisited || !this.LeftVisited3))
                    {
                            extentions.Add(new KeyValuePair<DeBruijnNode,bool>(this.LeftExtension3, this.OrientationLeftExtension3));
                        
                    }
                }
                //things on left with same orientation connected on right, otherwise left
                foreach (var kv in extentions)
                {
                    this.MarkLeftExtensionAsVisited(kv.Key);
                    if (kv.Value)
                    {
                        kv.Key.MarkRightExtensionAsVisited(this);
                    }
        ...
        /// </summary>
        public DeBruijnNode(KmerData32 value, ushort count)
        {
        ...
        /// </summary>
        public UInt32 KmerCount { get; set; }
        ...
        /// <summary>
        /// Sets all edges of this node to a visit state of false.
        /// </summary>
        public void ResetVisitState()
        {
            _visitedNodeExtensions = (byte)0;
        }
