            ...
            switch (this._currentStep)
            {
                case 2:
                    if (!this.Graph.GraphBuildCompleted)
                    {
                        ...
                        {
                            this._statusMessage = string.Format(CultureInfo.CurrentCulture, Properties.Resource.CreateGraphSubStatus, this.Graph.SkippedSequencesCount, this.Graph.ProcessedSequencesCount,this.Graph.NodeCount);
