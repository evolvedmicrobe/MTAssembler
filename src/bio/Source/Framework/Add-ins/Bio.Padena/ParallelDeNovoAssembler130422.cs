...
namespace Bio.Algorithms.Assembly.Padena
{
    ...
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1708:IdentifiersShouldDifferByMoreThanCase"), RegistrableAttribute(true)]
    public class ParallelDeNovoAssembler : IDeBruijnDeNovoAssembler, IDisposable
    {
        ...
        /// </summary>
        protected int dangleThreshold = 0;

        /// <summary>
        /// Bool to do erosion or not.
        /// </summary>
        protected bool isErosionEnabled = false;

        /// <summary>
        /// User Input Parameter
        /// Threshold for eroding low coverage ends.
        /// </summary>
        protected int erosionThreshold = -1;

        /// <summary>
        /// User Input Parameter
        /// Length Threshold for removing redundant paths in graph.
        /// </summary>
        protected int redundantPathLengthThreshold = 0;

        /// <summary>
        /// Threshold used for removing low-coverage contigs.
        /// </summary>
        protected double contigCoverageThreshold = -1;

        /// <summary>
        /// Class implementing Low coverage contig removal.
        /// </summary>
        protected ILowCoverageContigPurger lowCoverageContigPurger;
        ...
        /// </summary>
        protected IEnumerable<ISequence> sequenceReads;
        ...
        /// </summary>
        protected DeBruijnGraph graph;

        /// <summary>
        /// Class implementing dangling links purging.
        /// </summary>
        protected IGraphErrorPurger danglingLinksPurger;

        /// <summary>
        /// Class implementing redundant paths purger.
        /// </summary>
        protected IGraphErrorPurger redundantPathsPurger;

        /// <summary>
        /// Class implementing contig building.
        /// </summary>
        protected IContigBuilder contigBuilder;

        /// <summary>
        /// Class implementing scaffold building.
        /// </summary>
        protected IGraphScaffoldBuilder scaffoldBuilder;
        ...
        /// </summary>
        protected System.Timers.Timer progressTimer;
        ...
        public virtual IDeNovoAssembly Assemble(IEnumerable<ISequence> inputSequences)
        {
            ...
            this.TaskTimeSpanReport(end - start);
        ...
        {
            this.currentStep = 0;
            this.progressTimer = new System.Timers.Timer(ProgressTimerInterval);
        ...
        {
            this.statusMessage = string.Format(CultureInfo.CurrentCulture, Properties.Resource.TimeSpanReport, ts);
            this.RaiseStatusEvent();
        ...
        {
            this.statusMessage = string.Format(CultureInfo.CurrentCulture, Properties.Resource.GraphNodeCountDisplay, this.graph.NodeCount);
            this.RaiseStatusEvent();
        }
